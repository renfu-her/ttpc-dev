...
<div class="box-header txt_12"><span>|| 後台管理介面 > 新增帳號管理</span>
...
<div class="text-center txt_title"><strong>新增帳號管理</strong></div>
<div class="box-body">
	<div class="form-group">
   		<label class="col-md-2 control-label">帳號：</label>
    	<div class="col-md-10">       
    	<input name="id"  id="id" type="text"  value=""  required="required" data-error="請填寫帳號" />
    ...
    <div class="form-group">
     ...
     <div class="form-group">
    	...
    	<select name="power" id="power" required data-error="請選擇權限">
                      ...
                      <option value="1">操作人員</option>

                      <option value="2">凍結使用</option>
