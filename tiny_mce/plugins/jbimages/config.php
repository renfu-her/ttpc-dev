...
//找出主機網址
/*
$this_object=array_pop(explode("/",$_SERVER['PHP_SELF']));	
$this_relatively_url=explode($this_object,$_SERVER['PHP_SELF']);
$this_relatively_url=$this_relatively_url[0]."../../../../..";
$this_relatively_url=$this_relatively_url."/pic/tinymce";
$config['img_path']=$this_relatively_url;	//相對domain的位置/stand/pic/tinymce
//找出主機網址
$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
*/

	$config['img_path'] = '/photo'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] .$config['img_path']; // Physical path. [Usually works fine like this]
...
| -------------------------------------------------------------------*/
	...
	$config['allowed_types'] = 'gif|jpg|png|gif|bmp';
